...
- 💾 **خروجی ساختاریافته JSON و صفحات وب آفلاین HTML:** مناسب برای مطالعه آفلاین، بایگانی شخصی، توسعه‌دهندگان، مهاجرت به وردپرس و وبلاگ.
...
```text
ویرگول, بک‌آپ ویرگول, virgool, virgool backup, پشتیبان‌گیری ویرگول, استخراج مقالات ویرگول, دانلود مقالات ویرگول, تبدیل ویرگول به pdf, چاپ مقالات ویرگول, کتابچه ویرگول, خروجی json ویرگول, خروجی html ویرگول, نظرات ویرگول, نویسندگی, وبلاگ نویسی فارسی, آرشیو وبلاگ
```
...
- **مجوزها (Permissions):**
  ...
  - `downloads`: برای ذخیره فایل‌های PDF، JSON و HTML
