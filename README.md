...
| :---: | :---: | :---: | :---: | :--- |
| **۱ (پیش‌فرض)** | **۱ ترد (Single Thread)** | **۰.۰۵ ثانیه (۵۰ms)** | 🟢 بسیار کم (امن) | کاربران خانگی با اینترنت معمولی و بدون عجله |
...
- **خروجی تکی مارک‌داون (Single Markdown Export):**
  امکان دانلود تک‌تک مقالات به صورت فایل `.md` همراه با هدر استاندارد YAML Frontmatter مناسب برای گیت‌بوک و سایت‌های استاتیک نظیر Astro، Hugo یا Jekyll.
...
│       └── markdown-exporter.js # صادرکننده مقالات به فایل‌های مارک‌داون
