...
export function parsePostHtml(htmlString) {
  if (!htmlString) {
    return { title: '', bodyHtml: '', bodyMarkdown: '', plainText: '', images: [] };
  }

  // Strip <head>, <link>, <script>, <style>, and <meta> tags completely before parsing
  // so browser never triggers link preloads (e.g. Vazir fonts or chunks) or script execution
